var local_static_assets = '../contentfiles/';
var server_cdn = 'http://mohrlab.northwestern.edu/billboard//contentfiles/';
...
var captureButtonPresses = function() {

  $(".btn, input, textarea, select").on("click", function(ev){
    PurpleRobotClient.emitReading("clicks",{page:window.location.pathname, currentTarget:ev.currentTarget.toString()},'addToQueue');
...
// PurpleRobotClient.serverUrl = "http://165.124.198.95:12345/json/submit";http://192.168.43.1:12345/
PurpleRobotClient.serverUrl = "http://localhost:12345/json/submit";
// PurpleRobotClient.serverUrl = "http://192.168.43.1:12345:12345/json/submit";
